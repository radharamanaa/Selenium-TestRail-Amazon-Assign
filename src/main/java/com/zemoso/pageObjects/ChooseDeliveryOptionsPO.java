...
public class ChooseDeliveryOptionsPO extends GenericDriver {
    By deliveryDay = By.xpath("/html/body/div[5]/div[1]/div/div[2]/div/div[1]/form/div[2]/div[1]/div[2]/div[1]/div/div/div[1]/div/div/div[2]/span/span");
    By continueButton = By.cssSelector("input.a-button-text[value='Continue']:first-of-type");
